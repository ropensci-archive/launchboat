...
fail_fmt <- formatter("span", style = x ~ style(display = "block",padding = "0 4px", `border-radius` = "4px",  `background-color` = ifelse(x, "lightpink", "white")))
skip_fmt <- formatter("span", style = x ~ style(display = "block",padding = "0 4px", `border-radius` = "4px",  `background-color` = ifelse(x, "yellow", "white")))
...
```{r covr, echo=FALSE}
source("coverage-report-widget.R")
